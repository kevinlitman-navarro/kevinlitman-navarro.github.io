(function () { 
  ...
  var economyWeight = 1
  var researchAndDevelopmentWeight = 1
  var inclusionWeight = 1
...
function buildHeatmap(rawData) {
  ...
  var tip = d3.tip()
    ...
    .offset([-10, 0])
    .html(function(d) {
      return "<strong class='trend-country-name'>" + rawData.filter(row => isCountry(row,d.code))[0].country + "</strong>" + "<span class='super-font'>" + "<br>" + "&mdash;&mdash;&mdash;&mdash;<br>" + d.metrics  + ": " + (d.index_score*1).toFixed(2) + "</span>"
    }) 
